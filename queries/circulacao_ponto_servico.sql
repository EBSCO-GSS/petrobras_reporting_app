--metadb:function circulacao_ponto_servico

DROP FUNCTION IF EXISTS circulacao_ponto_servico;

CREATE FUNCTION circulacao_ponto_servico(
...
SELECT distinct 
	...
	sp.discovery_display_name  "Ponto Serviço",
...
WHERE l.loan_date BETWEEN start_date AND end_date
  ...
  and i2.__current and i.__current
group by data_emprestimo, sp.discovery_display_name
ORDER BY data_emprestimo  desc, sp.discovery_display_name
