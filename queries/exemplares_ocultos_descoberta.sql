--metadb:function producao_exemplares_ocultos_descoberta

DROP FUNCTION IF EXISTS producao_exemplares_ocultos_descoberta;

CREATE FUNCTION producao_exemplares_ocultos_descoberta(
