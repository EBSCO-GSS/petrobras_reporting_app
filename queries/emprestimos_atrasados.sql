--metadb:function emprestimos_atrasados

DROP FUNCTION IF EXISTS emprestimos_atrasados;

CREATE FUNCTION emprestimos_atrasados(
...
ORDER BY data_devolucao_esperada  desc, usuario_nome
$$
LANGUAGE SQL
STABLE
PARALLEL SAFE;
